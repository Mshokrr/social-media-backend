                              ...
                              >
                                <div class="heading-section">
                                  ...
                                  ${
                                    params.button
                                      ? `<p>
                                    <a href="${params.link}" class="btn btn-primary">${params.buttonText}</a>
                                  </p>`
                                      : ''
                                  }
                                </div>
            ...
            <td valign="middle" class="bg_white footer">
              <table>
                <tr style="text-align: left;">
                  ...
                  >
                    <h3 class="heading">Stay tuned for our latest news</h3>
                  </td>
                  <td
                    valign="middle"
                    width="40%"
                    ...
                    <ul class="social">
                      <li>
                        <a href="https://twitter.com">
                          <img
                            src="cid:twitter-logo"
                            alt=""
                            style="width: 18px; max-width: 600px; height: auto; display: block;"
                          />
                        </a>
                      </li>
                      <li>
